...
// NewInitCommand creates a minimal local app manifest.
...
// InitOptions configures local app manifest initialization.
type InitOptions struct {
	Force bool
}

// Init creates a minimal secure local app manifest.
