...
func Bundle() resource.ContributionBundle {
	agentSpec := sdk.BuildAgent(AgentName).
		...
		WithSystem("You are agentsdk coder. Help with coding tasks using concise, concrete steps. "+
			...
			"Use project_inventory/project_docs/project_tasks for workspace structure, go_info/go_env/go_version for Go toolchain orientation, and go_project/go_packages/go_outline/go_symbol/go_definition/go_symbol_info/go_references/go_imports/go_implementations/go_callers/go_callees for Go code navigation. "+
		...
		WithOperations(
			...
			"go_project", "go_info", "go_env", "go_version", "go_packages", "go_outline", "go_symbol", "go_definition", "go_symbol_info", "go_references", "go_imports", "go_implementations", "go_callers", "go_callees",
		...
		WithDefaultSession(coresession.Spec{
			...
			Delegation: coresession.DelegationPolicy{
				...
				Operations: []operation.Ref{
					...
					{Name: "go_project"}, {Name: "go_info"}, {Name: "go_env"}, {Name: "go_version"}, {Name: "go_packages"}, {Name: "go_outline"}, {Name: "go_symbol"}, {Name: "go_definition"}, {Name: "go_symbol_info"}, {Name: "go_references"}, {Name: "go_imports"}, {Name: "go_implementations"}, {Name: "go_callers"}, {Name: "go_callees"},
