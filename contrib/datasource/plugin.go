...
var _ contributions.ConfigSchemaContributor = Plugin{}
...
func (Plugin) Manifest() contributions.Manifest {
	return contributions.Manifest{Name: Name, Description: "Generic datasource search and retrieval tools."}
}
...
func (Plugin) ConfigSchemaContributions(context.Context, contributions.Context) (resource.ContributionBundle, error) {
	return resource.ContributionBundle{
...
func (p Plugin) Operations(context.Context, contributions.Context) ([]operation.Operation, error) {
...
func (p Plugin) ContextProviders(context.Context, contributions.Context) ([]corecontext.Provider, error) {
