...
func TestParallelIntentAssertionDeriver(t *testing.T) {
	derivers, err := New().AssertionDerivers(context.Background(), contributions.Context{})
	if err != nil {
...
func TestParallelIntentReactionEnablesTaskOperationSet(t *testing.T) {
	rules, err := New().Reactions(context.Background(), contributions.Context{})
	if err != nil {
...
func TestTaskCreatePersistsEventsAndDefaultsReady(t *testing.T) {
	...
	ops, err := New().Operations(context.Background(), contributions.Context{EventStore: events})
	if err != nil {
...
func TestTaskRunAndSchedulerControlsUseRunner(t *testing.T) {
	...
	ops, err := NewWithRunner(runner).Operations(context.Background(), contributions.Context{EventStore: eventstore.NewMemoryStore()})
	if err != nil {
		t.Fatalf("Operations: %v", err)
	}
	byName := operationsByName(ops)
...
func TestTaskRunFailsWithoutScheduler(t *testing.T) {
	ops, err := New().Operations(context.Background(), contributions.Context{EventStore: eventstore.NewMemoryStore()})
	if err != nil {
		t.Fatalf("Operations: %v", err)
	}
...
func TestTaskRunRecordsCurrentSessionWatcher(t *testing.T) {
	...
	ops, err := NewWithRunner(runner).Operations(context.Background(), contributions.Context{EventStore: events})
	if err != nil {
		t.Fatalf("Operations: %v", err)
	}
	byName := operationsByName(ops)
...
func TestTaskCreateFailsWithoutEventStore(t *testing.T) {
	ops, err := New().Operations(context.Background(), contributions.Context{})
	if err != nil {
		t.Fatalf("Operations: %v", err)
	}
