...
var _ contributions.ReactionProvider = Plugin{}
...
func (Plugin) Manifest() contributions.Manifest {
	return contributions.Manifest{Name: Name, Description: "Task creation commands, agents, and operations."}
}
...
func (Plugin) Reactions(context.Context, contributions.Context) ([]corereaction.Rule, error) {
