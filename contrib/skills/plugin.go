...
func (Plugin) Manifest() contributions.Manifest {
	return contributions.Manifest{Name: Name, Description: "Skill activation, context, and datasource access."}
}
...
func (p Plugin) DatasourceProviders(context.Context, contributions.Context) ([]coredatasource.Provider, error) {
