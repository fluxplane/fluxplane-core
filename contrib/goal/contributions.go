...
var _ contributions.SessionCommandProvider = Plugin{}
...
func (Plugin) Manifest() contributions.Manifest {
	return contributions.Manifest{Name: Name, Description: "Durable session goal lifecycle and context."}
}
...
func (Plugin) Contributions(context.Context, contributions.Context) (resource.ContributionBundle, error) {
	return resource.ContributionBundle{
		...
		ContextProviders: []corecontext.ProviderSpec{{
			Name:             runtimegoal.ContextProviderName,
...
func (Plugin) SessionCommands(context.Context, contributions.Context) ([]session.SessionCommandBinding, error) {
...
func (Plugin) ContextProviders(_ context.Context, ctx contributions.Context) ([]corecontext.Provider, error) {
	...
	return []corecontext.Provider{runtimegoal.ContextProvider{Store: store}}, nil
}

func (Plugin) Operations(_ context.Context, ctx contributions.Context) ([]operation.Operation, error) {
	if ctx.EventStore == nil {
		return nil, nil
	}
	store, err := runtimethread.NewStore(ctx.EventStore)
